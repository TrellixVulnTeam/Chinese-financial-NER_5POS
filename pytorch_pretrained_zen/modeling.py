...
class ZenModel(ZenPreTrainedModel):
    ...
    def forward(self, input_ids,
        ...
        encoded_layers = self.encoder(embedding_output,
                                      ...
                                      head_mask=head_mask)
        """
        Modifications added gating mechanism where > 0.55 of the direct input embedding_output layer, < 0.55 of which still use ngrams
        """
        if embedding_output.sum()>-500:
        ...
        # print("ngram_embedding_output",ngram_embedding_output.shape)
