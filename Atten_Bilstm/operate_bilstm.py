...
from Atten_Bilstm.models.BILSTM import BiLSTM, cal_loss
from Atten_Bilstm.models.BILSTM_CRF import BiLSTM_CRF, cal_lstm_crf_loss
from Atten_Bilstm.config import TrainingConfig, LSTMConfig
from Atten_Bilstm.utils import sort_by_lengths, tensorized
...
class BiLSTM_operator(object):
    ...
    def test(self, word_lists, tag_lists, word2id, tag2id):
        ...
        tensorized_sents = tensorized_sents
        ...
        #
        # print("第三个标注点")
        # print(pred_tag_lists, tag_lists)

        return batch_tagids


if __name__ == '__main__':
    oper = BiLSTM_operator(vocab_size=64, out_size=7, crf=True)
    # oper.train()
